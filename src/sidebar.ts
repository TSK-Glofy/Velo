...
export function renderSidebar(
  ...
  sidebar.innerHTML = `
    <button class="btn btn-ghost btn-square sidebar-btn active" data-page="home" title="首页">
      ${ICONS.home}
    </button>
    <div class="flex-1"></div>
    <button class="btn btn-ghost btn-square sidebar-btn" data-page="settings" title="设置">
      ${ICONS.settings}
    </button>
    <div class="mb-2"></div>
  `;
