...
const ICONS = {
  ...
  gif: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2"/><path d="m9 9 6 3-6 3Z"/></svg>`,
  tasks: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M8 6h13"/><path d="M8 12h13"/><path d="M8 18h13"/><path d="M3 6h.01"/><path d="M3 12h.01"/><path d="M3 18h.01"/></svg>`,
...
const NAV_ITEMS: { page: Page; icon: string; labelKey: string; position: "top" | "bottom" }[] = [
  ...
  { page: "gif", icon: ICONS.gif, labelKey: "sidebar.gif", position: "top" },
  { page: "tasks", icon: ICONS.tasks, labelKey: "sidebar.tasks", position: "top" },
  { page: "settings", icon: ICONS.settings, labelKey: "sidebar.settings", position: "bottom" },
];

export type Page = "trim" | "merge" | "frames" | "gif" | "tasks" | "settings";
